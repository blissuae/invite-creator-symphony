...
export const addFooter = (doc: jsPDF, pageNum: number, totalPages: number, margin: number) => {
  ...
  // Add company info with improved typography
  ...
  // Add page number with clean typography
  doc.setFont('helvetica', 'normal');
  doc.setFontSize(8);
  doc.text(`Page ${pageNum} of ${totalPages}`, pageWidth - margin - 25, footerY);
  
  // Add social media with cleaner icons
  ...
  // Social media handle with clean typography
