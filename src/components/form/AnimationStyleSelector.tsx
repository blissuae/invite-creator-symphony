...
export const AnimationStyleSelector = ({
  selected,
  onSelect
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-serif mb-4 text-elegant-brown">Please select the designs that you like the most!</h2>
        <p className="text-gray-600 font-serif">Select up to 3 designs that inspire you. This will help us match your creative vision :)</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {ANIMATION_STYLES.map(style => (
          ...
          >
            <div className={`relative w-40 h-40 rounded-lg overflow-hidden transition-all ${
