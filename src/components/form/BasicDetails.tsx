  ...
  return <div className="space-y-6 sm:space-y-8 animate-fadeIn">
      ...
      <div className="space-y-4">
        <label className="block">
          ...
          <Input type="text" value={formData.fullName} onChange={e => onChange("fullName", e.target.value)} placeholder="Enter your full name" className="w-full border-elegant-secondary/30 focus:border-elegant-primary h-9 sm:h-10 text-sm sm:text-base" required />
        </label>
        ...
        <label className="block">
          ...
          <Select value={formData.occasion} onValueChange={value => onChange("occasion", value)}>
            ...
            <SelectContent className="bg-white">
              {OCCASIONS.map(occasion => <SelectItem key={occasion.value} value={occasion.value} className="font-serif flex items-center text-sm sm:text-base py-1.5 sm:py-2">
                  {occasion.icon}
                  {occasion.label}
                </SelectItem>)}
            </SelectContent>
        ...
        {formData.occasion === "Other" && <label className="block">
            <span className="text-elegant-brown font-serif block mb-1.5 sm:mb-2 text-sm sm:text-base">
              Custom Occasion <span className="text-red-500">*</span>
            </span>
            <Input type="text" value={formData.customOccasion} onChange={e => onChange("customOccasion", e.target.value)} placeholder="Enter your occasion" className="w-full border-elegant-secondary/30 focus:border-elegant-primary h-9 sm:h-10 text-sm sm:text-base" required />
          </label>}
      </div>
